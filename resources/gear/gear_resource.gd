...
@export var helmet_dictionary = {
	"base":{
		...
		"defense": 4,
		"armor": 1,
		"ability": preload("res://custom_resources/abilities/buff.tres")
	},
	"halloween":{
		"name": "halloween",
		"category" :"helmets",
...
@export var wing_dictionary = {
	"base":{
		...
		"defense": 4,
		"armor": 1,
		"ability": preload("res://custom_resources/abilities/chill.tres")
	},
	"buffalo":{
		"name": "buffalo",
		"category" :"wings",
...
@export var foot_dictionary = {
	"base":{
		...
		"defense": 4,
		"armor": 1,
		"ability": preload("res://custom_resources/abilities/scorch.tres")
	},
	"bone":{
		"name": "bone",
		"category": "feet",
